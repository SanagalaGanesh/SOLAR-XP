...
namespace core.Migrations
{
    ...
    [Migration("20251217102810_Table up")]
    partial class Tableup
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("core.SolarEntities.ClientOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("core.SolarEntities.QuoteHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("QuoteHeaders");
                });

            modelBuilder.Entity("core.SolarEntities.QuoteItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("core.SolarEntities.SolarProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("core.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("core.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("core.SolarEntities.ClientOrder", b =>
                {
                    b.HasOne("core.SolarEntities.QuoteItem", "QuoteItem")
                        .WithMany()
            ...
            modelBuilder.Entity("core.SolarEntities.QuoteHeader", b =>
                {
                    b.HasOne("core.Authorization.Users.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("core.SolarEntities.QuoteItem", b =>
                {
                    b.HasOne("core.SolarEntities.QuoteHeader", "QuoteHeader")
                        .WithMany("QuoteItems")
                        .HasForeignKey("QuoteHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("core.SolarEntities.SolarProduct", "SolarProduct")
                        .WithMany()
