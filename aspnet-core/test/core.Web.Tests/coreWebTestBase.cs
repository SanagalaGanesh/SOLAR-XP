...
public abstract class coreWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static coreWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(coreWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<coreDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<coreDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<coreDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<coreDbContext, Task<T>> func)
    {
        T result;
